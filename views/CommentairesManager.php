            ...
            <div class="d-flex flex-row card-body card mb-3">
                ...
                <form class="form-inline">
                    ...
                    <div class="text-right icon_container iconCommentaireManager ml-auto">
                        <a class="btn btn-primary signalercomment" href="index.php?action=approuverComment&amp;id=<?= $comments['id'] ?>"><i class="fas fa-check"></i></a>
                        <a class="btn btn-danger mr-4 mr-lg-0 signalercomment" href="index.php?action=deleteCommentaire&amp;id=<?= $comments['id'] ?>"><i class="far fa-trash-alt"></i></a>
                    </div>
                </form>
            </div>
            </div>
    ...
    <?php } else if ($comments['signaler'] == 0){ ?>
        <div class="row mr-5 ml-5" id="SkateparkCommentaire">
            <div class="d-flex flex-row card-body card mb-3">
                ...
                <form class="form-inline">
                    <p class="mt-2 ml-4 ml-lg-0"><?= $comments['contenu'] ?></p>
                    <a class="btn btn-danger ml-auto mr-4 mr-lg-0 signalercomment" href="index.php?action=deleteCommentaire&amp;id=<?= $comments['id'] ?>"><i class="far fa-trash-alt"></i></a>
                </form>
            </div>
            </div>
        </div>
